<template>
    <div class="home">
        ...
        >
            <vs-select-item :key="index" :value="item.CountryCode" :text="item.Country"
                            v-for="(item,index) in summary.Countries"/>
        </vs-select>
                        ...
                        datasets: [
                            {
                                ...
                                type: "line",
                                borderColor: "#2fa2a2",
                                backgroundColor: 'rgba(47,162,162,0.3)',
